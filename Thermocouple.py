...
class Thermocouple:
    def __init__(self):
        ...
        self.mdot_cool = 3000  # wall cooling flow
    ...
    def main(self):
        ...
        for i in range(len(T_wall_k)):
            roots, rad, rad_chamb = self.heat_balance(T_wall_k[i])
        ...
        host.set_ylabel("Heat Transfer (W)")
